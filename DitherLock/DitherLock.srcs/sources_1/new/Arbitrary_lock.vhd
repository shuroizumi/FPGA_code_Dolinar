...
architecture Behavioral of Arbitrary_lock is
...
signal errorsig_DC_reg : std_logic_vector (31 downto 0):= "00000000000000000000000000000000";
signal errorsig_DC : std_logic_vector (31 downto 0):= "00000000000000000000000000000000";
signal g1float : std_logic_vector (31 downto 0):= "00000000000000000000000000000000";
signal g2float : std_logic_vector (31 downto 0):= "00000000000000000000000000000000";
signal g1float_reg : std_logic_vector (31 downto 0):= "00000000000000000000000000000000";
signal g2float_reg : std_logic_vector (31 downto 0):= "00000000000000000000000000000000";
...
istd_vector_to_floatingg1: std_vector_to_floating port map(
clk=>clk, 
std_vector=>Wg1(31 downto 0),
floating=>g1float,
convert=>'1'
);  
  
istd_vector_to_floatingg2: std_vector_to_floating port map(
clk=>clk, 
std_vector=>Wg2(31 downto 0),
floating=>g2float,
convert=>'1'
);  
...
when "01011" =>
     if (m_axis_result_tvalid='0') then
       g1float_reg <=m_axis_result_tdata;
       m_axis_result_tready<='0';
       convertstage<=convertstage+1;
     end if; 

when "01100" =>
     s_axis_a_tdata<=g2float; 
     s_axis_b_tdata<="01000100011110100000000000000000";    
     convertstage<=convertstage+1;
when "01101" =>
     s_axis_a_tvalid<='1';
...
when "01111" =>
      if (m_axis_result_tvalid='0') then
        g2float_reg <=m_axis_result_tdata;
        m_axis_result_tready<='0';
        convertstage<="00000";
      end if; 
...
if (lockmode='0') then
    ...
    case state_reg is
        ...
        when "00010" =>
           ...
           when "0000" =>
                s_axis_a_tdata2<=APDcountfloat; 
                s_axis_b_tdata2<=errorsig_DC_reg;    
           ...
           when "0001" =>
                ...
                stage_errorsigLfloat<=stage_errorsigLfloat+1;
           when "0010" =>
                if (m_axis_result_tvalid1='1' and m_axis_result_tvalid2='1') then
           ...
           when "0011" =>
                 if (m_axis_result_tvalid1='0' and m_axis_result_tvalid2='0') then
                    if (APDcountfloat="00000000000000000000000000000000") then
                         demod <=(others => '0');
                         errorsig_DC_reg <=(others => '0');
                    else     
                         demod <=m_axis_result_tdata1;
                         errorsig_DC_reg <=m_axis_result_tdata2;
                    end if;     
        ...
        when "00110" =>
           ...
           when "0000" =>
               ...
               s_axis_b_tdata1<=g1float_reg;    
               s_axis_a_tdata6<=errorsig_DC; 
               s_axis_b_tdata6<=g2float_reg;                   
           ...
           when "0011" =>
                if (m_axis_result_tvalid1='0' and m_axis_result_tvalid6='0') then
                   errorsig <=m_axis_result_tdata1;
                   errorsig_DC<=m_axis_result_tdata6;
                   m_axis_result_tready1<='0';
                   m_axis_result_tready6<='0';
...
--              state_reg<=state_reg+1;
        ...
        when "10011" =>
                if (sw1='0' and sw2='0') then
                    led(15 DOWNTO 0)<=Vquotientfloat(15 DOWNTO 0);
                elsif (sw1='1' and sw2='0') then
                    led<=Vquotientfloat(31 DOWNTO 16);
                elsif (sw1='0' and sw2='1') then
                    led<=errorsig(15 DOWNTO 0);
