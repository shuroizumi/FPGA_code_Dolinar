...
set_property PACKAGE_PIN R7 [get_ports {switch[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {switch[0]}]
#Bank = 34, Pin name = IO_L19P_T3_34,						Sch name = SW3
set_property PACKAGE_PIN R6 [get_ports {switch[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {switch[1]}]
#Bank = 34, Pin name = IO_L19N_T3_VREF_34,					Sch name = SW4
set_property PACKAGE_PIN R5 [get_ports {switch[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {switch[2]}]
#Bank = 34, Pin name = IO_L20P_T3_34,						Sch name = SW5
set_property PACKAGE_PIN V7 [get_ports {switch[3]}]					
...
set_property PACKAGE_PIN B13 [get_ports {JAtop[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {JAtop[0]}]
#Bank = 15, Pin name = IO_L5N_T0_AD9N_15,					Sch name = JA2
set_property PACKAGE_PIN F14 [get_ports {JAtop[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {JAtop[1]}]
##Bank = 15, Pin name = IO_L16N_T2_A27_15,					Sch name = JA3
#set_property PACKAGE_PIN D17 [get_ports {JAtop[2]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {JAtop[2]}]
##Bank = 15, Pin name = IO_L16P_T2_A28_15,					Sch name = JA4
#set_property PACKAGE_PIN E17 [get_ports {JAtop[3]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {JAtop[3]}]
...
#set_property PACKAGE_PIN G14 [get_ports {JBtop[0]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {JBtop[0]}]
##Bank = 14, Pin name = IO_L13P_T2_MRCC_14,					Sch name = JB2
#set_property PACKAGE_PIN P15 [get_ports {JBtop[1]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {JBtop[1]}]
##Bank = 14, Pin name = IO_L21N_T3_DQS_A06_D22_14,			Sch name = JB3
#set_property PACKAGE_PIN V11 [get_ports {JBtop[2]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {JBtop[2]}]
##Bank = CONFIG, Pin name = IO_L16P_T2_CSI_B_14,				Sch name = JB4
#set_property PACKAGE_PIN V15 [get_ports {JBtop[3]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {JBtop[3]}]
#Bank = 15, Pin name = IO_25_15,							Sch name = JB7
set_property PACKAGE_PIN K16 [get_ports {JBbottom[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {JBbottom[4]}]
#Bank = CONFIG, Pin name = IO_L15P_T2_DQS_RWR_B_14,			Sch name = JB8
set_property PACKAGE_PIN R16 [get_ports {JBbottom[5]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {JBbottom[5]}]
#Bank = 14, Pin name = IO_L24P_T3_A01_D17_14,				Sch name = JB9
set_property PACKAGE_PIN T9 [get_ports {JBbottom[6]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {JBbottom[6]}]
#Bank = 14, Pin name = IO_L19N_T3_A09_D25_VREF_14,			Sch name = JB10 
set_property PACKAGE_PIN U11 [get_ports {JBbottom[7]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {JBbottom[7]}]
 


##Pmod Header JC
#Bank = 35, Pin name = IO_L23P_T3_35,						Sch name = JC1
set_property PACKAGE_PIN K2 [get_ports {JC}]					
...
set_property PACKAGE_PIN K1 [get_ports {JCbottom[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {JCbottom[4]}]
#Bank = 35, Pin name = IO_L5P_T0_AD13P_35,					Sch name = JC8
set_property PACKAGE_PIN E6 [get_ports {JCbottom[5]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {JCbottom[5]}]
#Bank = 35, Pin name = IO_L22N_T3_35,						Sch name = JC9
set_property PACKAGE_PIN J2 [get_ports {JCbottom[6]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {JCbottom[6]}]
#Bank = 35, Pin name = IO_L19P_T3_35,						Sch name = JC10
set_property PACKAGE_PIN G6 [get_ports {JCbottom[7]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {JCbottom[7]}]
 

 
##Pmod Header JD
#Bank = 35, Pin name = IO_L21N_T2_DQS_35,					Sch name = JD1
set_property PACKAGE_PIN H4 [get_ports {JE}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {JE}]
